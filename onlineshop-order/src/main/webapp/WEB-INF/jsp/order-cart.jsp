...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="吴坤永"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18188883741"/>
		<input type="hidden" name="orderShipping.receiverState" value="广东省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="广州市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="海珠区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="广东财经大学广州校区"/>
		<input type="hidden" name="orderShipping.receiverZip" value="510000"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="mt10" limit="15">广东省 广州市 海珠区 </div>
						<div class="adr-m" limit="30">广东财经大学广州校区</div>
						<div>510000</div>
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<c:if test="${not cart.enough }">
						<span class="myenough" style="color:red">库存不足</span>
					</c:if>
