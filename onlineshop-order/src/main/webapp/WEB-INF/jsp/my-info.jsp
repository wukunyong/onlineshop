...
<input type="text" class="itxt" maxlength="20" id="nickName"
	name="userVo.nickName" value="wuky"> <div class="clr"></div><div
	class="prompt-06">
...
<input type="radio" name="sex" class="jdradio" value="0"><label
	class="mr10">男</label> <input type="radio" name="sex" class="jdradio"
	value="1"><label class="mr10">女</label> <input type="radio"
	name="sex" class="jdradio" value="2"><label class="mr10">保密</label>
</div>
</div>
<div class="item">
...
<option value="1930">1930</option></select> <label class="ml5 mr5">年</label> <select
	name="" class="selt selt1" id="birthdayMonth"><option
	value="0" disabled="" selected="selected">请选择：</option>
...
<option value="12">12</option></select> <label class="ml5 mr5">月</label> <select
	name="" class="selt selt1" id="birthdayDay"><option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
<option value="5">5</option>
...
<option value="28">28</option></select> <label class="ml5 mr5">日</label> <span
...
<div class="fl">
<div>
<strong> kunyongwu@163.com </strong><a target="_blank" class="ml5 ftx05"
...
</select> <select name="userVo.city" class="selt mr5" id="city" value="2826"><option
	value="78">海珠区</option>
<option value="2811">白云区</option>
<option value="2813">天河区</option>
<option value="2815">增城区</option>
<option value="2817">番禺区</option>
<option value="2822">黄埔区</option></select> <select name="userVo.county"
	class="selt mr5" id="county" value="2864"><option value="2864">仑头路</option></select>
<div class="clr"></div>
<div class="prompt-06">
...
<input type="text" class="itxt itxt1" name="userVo.address" id="address"
	value="广东财经大学"> <div class="clr"></div><div class="prompt-06">
...
<span class="label">&nbsp;</span>
<div class="fl">
<input id="code" value="100294" style="display: none"> <input
	id="rkey"
...
<a target="_blank" clstag="homepage|keycount|home2013|hbdsh"
	id="_MYJD_locallife" href="http://life.jd.com/localOrder/iniOrder.do">我的本地生活</a>
</dt>
</dl>
<dl class="fore4">
<dt>
