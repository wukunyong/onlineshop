	...
	<div class="w">
		...
		<ul class="fr lh">
			...
			<li class="fore2 ld" clstag="homepage|keycount|home2013|01c">
				<s></s>
				<a href="http://localhost:8086/order/myorder.html">我的订单</a>
			</li>
			<li class="fore2 ld" clstag="homepage|keycount|home2013|01c">
				<s></s>
				<a href="http://localhost:8084/user/showLogin" rel="nofollow">我的信息</a>
			</li>
			<!-- <li class="fore2-1 ld" id="jd-vip">
				<s></s>
				<a target="_blank" rel="nofollow" href="http://vip.jd.com">我的信息</a>
			</li> -->
